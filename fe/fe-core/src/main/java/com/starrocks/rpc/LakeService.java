...
public interface LakeService {
    ...
    @ProtobufRPC(serviceName = "LakeService", methodName = "delete_tablet_cache", onceTalkTimeout = TIMEOUT_DELETE_TABLET)
    Future<DeleteTabletCacheResponse> deleteTabletCache(DeleteTabletCacheRequest request);
