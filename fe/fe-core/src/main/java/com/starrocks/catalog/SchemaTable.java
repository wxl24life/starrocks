...
public class SchemaTable extends Table {
            ...
            ImmutableMap
                    ...
                    .put("be_logs", new SchemaTable(
                            ...
                            builder()
                                    ...
                                    .build()))
                    .put("routine_load_jobs", new SchemaTable(
                            SystemId.ROUTINE_LOAD_JOBS_ID,
                            "routine_load_jobs",
                            ...
                            builder()
                                    ...
                                    .build()))
                    .put("stream_loads", new SchemaTable(
                            SystemId.STREAM_LOADS_ID,
                            "stream_loads",
                            Table.TableType.SCHEMA,
                            builder()
                                    .column("LABEL", ScalarType.createVarchar(NAME_CHAR_LEN))
    ...
    public enum SchemaTableType {
        ...
        SCH_ROUTINE_LOAD_JOBS("ROUTINE_LOAD_JOBS", "ROUTINE_LOAD_JOBS", TSchemaTableType.SCH_ROUTINE_LOAD_JOBS),
        SCH_STREAM_LOADS("STREAM_LOADS", "STREAM_LOADS", TSchemaTableType.SCH_STREAM_LOADS);
