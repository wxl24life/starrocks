...
import com.starrocks.sql.optimizer.rule.implementation.PaimonIndexScanImplementationRule;
...
public class RuleSet {
    private static final List<Rule> ALL_IMPLEMENT_RULES = ImmutableList.of(
            ...
            new PaimonIndexScanImplementationRule(),
    ...
    public static final Rule APPLY_INDEX_RULES = new CombinationRule(RuleType.GP_APPLY_INDEX, ImmutableList.of(
