...
public enum RuleType {
    ...
    TF_EXTRACT_AI_FUNCTION_FROM_FILTER,
    TF_EXTRACT_NESTED_AI_FUNCTION_FROM_PROJECT,
    ...
    IMP_FLUSS_LSCAN_TO_PSCAN,
    IMP_PAIMON_INDEX_LSCAN_TO_PSCAN,
