...
public class CatalogRecycleBinLakeTableDropTableTest extends CatalogRecycleBinLakeTableTest {
     ...
     * This covers the edge case branches where lookups return null/empty results.
     */
    @Test
    public void testUtilityMethodsWithNonExistentIds() {
        ...
        // Covers the "partitionIds == null → return 0" path
        ...
        // Covers the "partitionIds == null → return false" path
        ...
        // Covers the "info == null → return false" path (info != null && info.isForceRemoveDirectory() short-circuits)
     ...
     * This covers the clear() method's new lines for lakeTableToPartitions and partitionsFromTableDeletion.
     */
    @Test
     ...
     * by erasePartition(). This covers the `partitionInfo == null` path in the cleanup loop.
     */
    @Test
    public void testRemoveTableFromRecycleBinWhenPartitionsAlreadyDeleted(
        ...
        // This covers the `if (partitionInfo != null)` false path.
        recycleBin.replayEraseTable(Lists.newArrayList(table.getId()));
     ...
     * This covers the "finished = false" path after future.get(), cleanup of asyncDeleteForPartitions,
     * and the retry scheduling via setNextEraseMinTime.
     */
    @Test
     ...
     * the table). This covers the `partitionIds == null` path in the cleanup code.
     */
    @Test
