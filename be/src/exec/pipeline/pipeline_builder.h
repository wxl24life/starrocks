...
public:
    ...
    OpFactories interpolate_local_bucket_exchange(RuntimeState* state, int32_t plan_node_id,
                                                  OpFactories& pred_operators,
                                                  const std::vector<ExprContext*>& partition_expr_ctxs,
                                                  const std::vector<ExprContext*>& bucket_expr_ctxs,
                                                  const std::vector<std::string>& bucket_key_names, int32_t bucket_num,
                                                  bool has_primary_key, int num_receivers);
